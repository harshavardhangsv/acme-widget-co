...
if __name__ == '__main__':
    ...
    delivery_rules_service1.add(Currency(0, CurrencyType.USD), Currency(49, CurrencyType.USD), Currency(4.95, CurrencyType.USD))
    delivery_rules_service1.add(Currency(50, CurrencyType.USD), Currency(89, CurrencyType.USD), Currency(2.95, CurrencyType.USD))
    delivery_rules_service1.default_rule(Currency(90, CurrencyType.USD), Currency(0, CurrencyType.USD))

    basket1 = Basket(product_catalogue1, delivery_rules_service1)
    basket1.add('B01')
    basket1.add('G01')
    assert basket1.total() == Currency(37.85, CurrencyType.USD)

    basket2 = Basket(product_catalogue1, delivery_rules_service1)
    basket2.add('R01')
    basket2.add('G01')
    assert basket2.total() == Currency(60.85, CurrencyType.USD)
